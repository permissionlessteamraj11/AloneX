...
from NarzoxBots.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("NarzoxBots/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("NarzoxBots/helpers/Inter-Light.ttf", 30)
